...
if(NOT CMAKE_Swift_CREATE_SHARED_LIBRARY)
  if(CMAKE_Swift_COMPILER_TARGET)
    set(CMAKE_Swift_CREATE_SHARED_LIBRARY
      "${CMAKE_Swift_COMPILER} -emit-library -target <CMAKE_Swift_COMPILER_TARGET> <FLAGS> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>")
  else()
    set(CMAKE_Swift_CREATE_SHARED_LIBRARY
      "${CMAKE_Swift_COMPILER} -emit-library <FLAGS> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>")
  endif()
endif()
